...
export default function OfficeBottomNav() {
  ...
  const navItems = [
    { 
      ...
      label: 'Jobs', 
      icon: '📋', 
      active: pathname.startsWith('/office/skips') 
    },
    { 
      href: '/office/tracker', 
      label: 'Tracker', 
      icon: '📍', 
      active: pathname.startsWith('/office/tracker') 
    },
    { 
      href: '/', 
      label: 'Home', 
      ...
      <div className="flex justify-around items-center h-16 px-2 max-w-lg mx-auto">
        {navItems.map((item) => (
          ...
          >
            ...
            {item.active && (
              <div className="absolute bottom-0 w-12 h-1 bg-blue-400 rounded-t-full" />
            )}
          </Link>
        ))}
      </div>
